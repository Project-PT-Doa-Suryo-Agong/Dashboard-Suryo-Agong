    ...
    <div className="p-4 md:p-6 lg:p-8 space-y-4 max-w-7xl mx-auto w-full">
      <section className="flex flex-col sm:flex-row justify-between gap-3 items-center">
        <div>
          ...
          <p className="text-slate-300">
            Kelola catatan hutang piutang perusahaan.
          </p>
        </div>
      </section>
      ...
      <section className="flex flex-col sm:flex-row justify-between gap-3 items-center">
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-xl bg-green-500 px-4 py-2 text-white font-semibold hover:bg-green-600"
        >
      ...
      <Modal
        ...
        title={editData ? "Edit Catatan" : "Catat Utang/Piutang"}
        maxWidth="max-w-2xl"
      >
            ...
            <div className="space-y-2">
              ...
              <select
                ...
                onChange={(e) =>
                  setFormData((f) => ({
                    ...f,
                    tipe: e.target.value as FinanceUtangPiutangTipe,
                  }))
                }
              ...
              >
                ...
                {coas.map((c) => (
                  <option key={c.id} value={c.id}>
                    {c.kode_akun} - {c.nama_akun} ({c.kategori})
                  </option>
                ))}
              </select>
            </div>
      ...
      <ConfirmDialog
        ...
        title="Hapus Catatan"
        description="Yakin hapus catatan ini?"
        variant="danger"
      />
    </div>
  );
