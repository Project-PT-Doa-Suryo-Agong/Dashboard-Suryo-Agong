...
export default function LandingPage() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col overflow-x-hidden bg-[#999999] font-display antialiased">
      <nav className="sticky top-0 z-50 w-full border-b border-white/10 bg-slate-700 px-3 py-3 backdrop-blur-md md:px-4 md:py-4 lg:px-6">
      ...
      <footer className="mt-auto w-full bg-[#1F2937] px-2 py-4 text-slate-300 md:px-4 md:py-8 lg:px-6 lg:py-7">
