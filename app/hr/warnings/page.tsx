...
const employeeOptions: EmployeeOption[] = [
	{ id: "emp-001", nama: "Rani Wulandari", posisi: "HR Generalist" },
	{ id: "emp-002", nama: "Bima Pratama", posisi: "Staff Finance" },
	{ id: "emp-003", nama: "Nadia Putri", posisi: "QC Lead" },
	{ id: "emp-004", nama: "Dwi Firmansyah", posisi: "Supervisor Logistik" },
	{ id: "emp-005", nama: "Salsa Maharani", posisi: "Content Specialist" },
	{ id: "emp-006", nama: "Agus Setiawan", posisi: "Office Assistant" },
];
...
export default function EmployeeWarningsPage() {
	...
	const employeeSelectOptions =
		filteredEmployeeOptions.length > 0 ? filteredEmployeeOptions : employeeOptions;
	...
	return (
		<div className="p-4 md:p-6 lg:p-8 space-y-4 md:space-y-6 max-w-7xl mx-auto w-full">
									...
									<td className="px-4 py-3">
										<div className="flex items-center justify-center gap-2">
											<button
												...
												aria-label={`Edit warning ${item.employeeName}`}
											>
												<Pencil size={16} />
											</button>
											<button
												...
												aria-label={`Hapus warning ${item.employeeName}`}
											>
												<Trash2 size={16} />
											</button>
										</div>
			...
			<ConfirmDialog
				...
				description="Hapus catatan peringatan ini dari histori karyawan?"
