    ...
    <div className="mx-auto flex h-[calc(100vh-120px)] w-full max-w-7xl flex-col gap-4 p-4 md:p-6 lg:p-8">
      ...
      <div className="flex min-h-0 flex-1 gap-4 md:gap-6">
        ...
        <aside className="h-full w-56 shrink-0 lg:w-64">
          <div className="flex h-full flex-col overflow-hidden rounded-xl border border-slate-200/10 bg-slate-100 p-3 shadow-sm">
            <p className="mb-2 flex shrink-0 items-center gap-2 text-xs font-semibold uppercase tracking-widest text-slate-700">
                    ...
                    <button
                      ...
                      className={`w-full rounded-lg px-3 py-2.5 text-left text-sm font-medium transition-all duration-150 ${
                        activeGroup === group.id
                          ...
                          : "text-slate-700 hover:bg-slate-700/60 hover:text-white"
                      }`}
                    >
                      {group.label}
                    </button>
