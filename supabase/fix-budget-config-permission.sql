    ...
    --   4. Ensure default privileges for new tables in management schema.
    -- ============================================================================
    ...
    --    Body function tetap sama dengan versi di remote schema dump.
    --    Jika live function sudah dimodifikasi, sesuaikan body-nya setelah
    --    konfirmasi.
    -- ================================================================
